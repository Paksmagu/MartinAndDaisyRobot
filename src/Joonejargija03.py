"""
- kohe sensoriga, mis üksteisest natuke eemal
- mõlemad peavad olema valge peal
- valge üle 70
- must alla 12
"""
...
def main():
    ...
    try:
        while (True):
            ...
            if (90 > reflection[0] > 50) and (90 > reflection[1] > 50):
                continue
            elif (reflection[0] <= 50) and (reflection[1] <= 50):
                continue
            elif reflection[0] <= 50:
                robot.turn("Left")
            elif reflection[1] <= 50:
                robot.turn("Right")
